...
# Soak scrub resume fixture, driven by a maintainer-private soak script. HEVC forces Transcode
...
PY
  ...
  # (Rule 4.7). The soak driver throttles further via its own THROTTLE_BPS.
  "$FFMPEG" -y -hide_banner -loglevel error \
