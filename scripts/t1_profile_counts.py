...
# Aether (ADR-0022): Matroska demux + AVPlayer loopback; client bridges
# codecs AVPlayer rejects. T1 floor matches Media3-wide accept for decide.
AETHER_V0 = Profile(
    name="AETHER_V0",
    video_codecs=frozenset(
        {
    ...
    containers=frozenset({"matroska", "webm", "mp4", "m4v", "mov", "avi", "mpegts", "mpeg"}),
    extensions=frozenset({"mkv", "webm", "mp4", "m4v", "mov", "avi", "ts", "m2ts"}),
    max_audio_channels=None,
    notes="Matroska yes; audio bridge for DTS/TrueHD/etc. T1 = decide_playback only.",
)

PROFILES = (APPLE_AVPLAYER_V0, ANDROID_MEDIA3_V0, AETHER_V0, MPV_V0, VLC_V0)
