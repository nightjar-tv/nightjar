...
- Amended: 2026-08-03 — session-shaped verify; one encode-leg builder; pix_fmt
  ...
  the Jellyfin HW encode map, 2026-08.
...
10. **Presence is not capacity.** A device or ICD that enumerates (DRM node,
    ...
    Spike pointer: the libplacebo DV spike note, 2026-08-02.
...
Research only (not requirements): the Jellyfin HW encode map, 2026-08.
