...
- Status: accepted (stack and Rule 2.4 amend); Apple engine (a)/(b) still open
- Date: 2026-07-31
- Accepted: 2026-08-01
...
- Rule 2.6 (client matrix) is now in the constitution so "works on one engine"
...
- Apple engine choice (a) vs (b), bake-off Part C, Aether n=228 T4, and
  Jellyfin T5-4 comparisons remain Phase 4 measurement work.
