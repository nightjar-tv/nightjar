...
previously locked Flutter over a shared Rust player core (Rule 2.4), with
Tizen/webOS via the web UI.
...
and the Apple engine choice (closed to AetherEngine on 2026-08-06).
